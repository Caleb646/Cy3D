...
namespace cy3d
{
	...
	struct ImageCreationAllocationInfo
	{
		...
		static ImageCreationAllocationInfo createDefaultImage(uint32_t width, uint32_t height, VkDeviceSize imageSize)
		{
			...
			return ImageCreationAllocationInfo{ imageInfo, allocCreateInfo, allocInfo, imageSize };
		}
	};
